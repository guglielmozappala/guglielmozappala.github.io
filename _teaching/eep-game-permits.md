...
- Pick your market (A or B) and join with your team's name. One phone per firm; at the usual attendance two of you share a firm.
...
Both markets trade under these rules. At the close we compare each market's price, abatement, emissions and total abatement cost with what the same firms would have paid had each met the cap on its own.

## The committee

You are no longer firms. Everyone gets a two-page dossier with both markets' results, and the class debates two amendments to the rules. You see them in class. Blank ballot, simple majority, and I have the casting vote if it is a tie. Before I open the ballots, the committee writes and signs one sentence predicting what the winning amendment will do. Then the coin: heads, market A gets the amendment and market B stays as it is; tails, the other way round. I announce the mapping before the flip.

## Round 2

Abatement is now more expensive for every firm in both markets, by the same amount. Open your card. The treated market runs the amendment, the control market runs the original rules. Trade again.
...
- Work out your reservation prices from your card before you trade: the most a permit is worth to you, and the least you should accept for one.
- Watch the book and the tape, not only your own orders.
- Nothing about the outcome is graded.
